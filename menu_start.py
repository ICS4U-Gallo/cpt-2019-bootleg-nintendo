...
def on_draw(game):
    ...
    if (game.width/2+150 > game.mouse_x > game.width/2-150 and
        game.height/2+100-game.start_y > game.mouse_y > game.height/2+25-game.start_y):
        arcade.draw_xywh_rectangle_outline(game.width/2-150-4,
                                           game.height/2+25-4-game.start_y,
                                           300+8, 75+8,
                                           arcade.color.RED, 7)
    else:
        arcade.draw_xywh_rectangle_outline(game.width/2-150,
                                           game.height/2+25-game.start_y, 300,
    ...
    if game.load is False:
        arcade.draw_text("Load Game", game.width/2,
                        game.height/2+63-125-game.start_y, arcade.color.GRAY, 30,
                        align="center", anchor_x="center",
                        anchor_y="center")

        arcade.draw_xywh_rectangle_outline(game.width/2-150,
                                       game.height/2-100-game.start_y, 300,
                                       75, arcade.color.GRAY, 5)

        arcade.draw_xywh_rectangle_outline(game.width/2-75/2,
                                        game.height/2-225-game.start_y, 75,
                                        75, arcade.color.GRAY, 5)

    else:
        arcade.draw_text("Load Game", game.width/2,
                        game.height/2+63-125-game.start_y, arcade.color.BLACK, 30,
                        align="center", anchor_x="center",
                        anchor_y="center")
        ...
        game.height/2-25 > game.mouse_y > game.height/2-100):
            arcade.draw_xywh_rectangle_outline(game.width/2-150-4,
                                        game.height/2-100-4-game.start_y, 300+8,
