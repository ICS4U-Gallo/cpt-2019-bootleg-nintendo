...
start_clock = 30  # animation purposes
start_y = -1000
...
class MyGame(arcade.Window):
    ...
    def on_update(self, delta_time):
        global game, start, load, start_clock, start_y
        ...
        if start is False:
            ...
            if (SCREEN_WIDTH/2+150 > self.mouse_x > SCREEN_WIDTH/2-150 and
                    SCREEN_HEIGHT/2+100-start_y > self.mouse_y > 
                    SCREEN_HEIGHT/2+25-start_y and
            ...
            if (SCREEN_WIDTH/2+75/2 > self.mouse_x > SCREEN_WIDTH/2-75/2 and
                    ...
                    and self.mouse_click is True and game is False):
                load = False
    ...
    def on_draw(self):
        ...
        if start is False:
            # for aesthetic purposes plz no touch
            pass
        else:
            if game is False:
                # start button v
            ...
            # end of menu code
                ...
                arcade.draw_text("Game started lmao xddd", SCREEN_WIDTH/2,
