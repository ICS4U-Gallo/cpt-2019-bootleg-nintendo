...
class Battle(arcade.Window):
    ...
    def display_pokemon(self):
        ...
        arcade.draw_xywh_rectangle_filled(125, poke.top + 30, 150 * (poke.cur_stats[0] / poke.stats[0]), 8,
                                          arcade.color.GREEN)
        ...
        arcade.draw_xywh_rectangle_filled(525, enemy.bottom - 30, 150 * (enemy.cur_stats[0] / enemy.stats[0]), 8,
                                          arcade.color.GREEN)
    ...
    def move_buttons(self):
        ...
        for i in range(len(poke.moves)):
            self.button_list.append(
                moveButton(self, 300 + (i % 2) * 200, 115 - (i // 2) * 75, 200, 70, poke.moves[i], self.theme))
        self.button_list.append(backButton(self, 700, 40, 200, 70, theme=self.theme))
    ...
    def switch_buttons(self):
        ...
        for i in range(len(self.player.pokemon)):
            self.button_list.append(
                switchButton(self, 100 + (i % 3) * 200, 115 - (i // 3) * 75, 200, 70, self.player.pokemon[i],
                             self.theme))
        self.button_list.append(backButton(self, 700, 40, 200, 70, theme=self.theme))
